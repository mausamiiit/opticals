...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/opticalsstorefront/electronics/en",
						"https://electronics.local:9002/opticalsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/opticalsstorefront/electronics/en",
						"https://electronics.local:9002/opticalsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/opticalsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/opticalsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/opticalsstorefront/electronics/en",
						"https://electronics.local:9002/opticalsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/opticalsstorefront",
						"https://electronics.local:9002/opticalsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/opticalsstorefront",
						"https://electronics.local:9002/opticalsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/opticalsstorefront/electronics/en",
						"https://electronics.local:9002/opticalsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

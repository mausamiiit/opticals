 ...
 */
package org.mausam.opticals.test.setup;
...
import org.mausam.opticals.test.constants.OpticalsTestConstants;
import org.mausam.opticals.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = OpticalsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/opticalstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/opticalstest/import/reviews.impex");
			...
			importImpexFile(context, "/opticalstest/import/cstickets.impex");
		}
	}
}

 ...
 */
package org.mausam.opticals.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(OpticalsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(OpticalsFulfilmentProcessConstants.PARENT_PROCESS);

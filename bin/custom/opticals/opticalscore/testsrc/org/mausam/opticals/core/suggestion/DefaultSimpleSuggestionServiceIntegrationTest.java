 ...
 */
package org.mausam.opticals.core.suggestion;
...
import org.mausam.opticals.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/opticalscore/test/testSimpleSuggestionService.csv", "utf-8");
	}
